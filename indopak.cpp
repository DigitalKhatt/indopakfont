...
namespace indopak {
	...
	Lookup* IndoPak::glyphalternates() {
		...
		altfeatures.push_back({ "cv12",{{"behshape.init.beforehah","behshape.init"},
			{"hah.medi.afterbeh","hah.medi" },
			{"hah.medi.afterbeh.besad","hah.medi.besad" },
			{"hah.medi.afterbeh.beforeyeh","hah.medi.beforeyeh"}} });
